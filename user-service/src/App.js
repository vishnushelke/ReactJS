...
import ComponentLifeCycle from "./components/JsFiles/ComponentLifeCycle";
import CompLifeCycle from "./components/JsFiles/CompLifeCycle";
import SearchNote from "./components/JsFiles/SearchNote";
    ...
    <div className="App">
      <Router>
        <switch>
          ...
          <Route path="/Dashboard/searchnote" component={SearchNote} />
